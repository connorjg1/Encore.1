...
/obj/item/paper/scroll/cargo/proc/rebuild_info()
	...
	if(signedname)
		info += "SIGNED,<br/>"
		info += "<font face=\"[FOUNTAIN_PEN_FONT]\" color=#27293f>[signedname] the [signedjob] of Etgard</font>"

/obj/item/paper/confession
	name = "confession"
	icon_state = "confession"
	info = "THE GUILTY PARTY ADMITS THEIR SIN AND THE WEAKENING OF THE ELEMENTAL BALANCE. THEY WILL REPENT AND SUBMIT TO ANY PUNISHMENT THE CLERGY DEEMS APPROPRIATE, OR BE RELEASED IMMEDIATELY. LET THIS RECORD OF THEIR SIN WEIGH ON THE DIVINE'S JUDGEMENT AT THE GATES OF HEAVEN.<br/><br/>SIGNED,"
	var/signed = FALSE
	textper = 150
...
/obj/item/paper/confession/attack(mob/living/carbon/human/M, mob/user)
	...
	if(!M.stat)
		...
		M.add_stress(/datum/stressevent/confessed)
		signed = M.real_name
		info = "THE GUILTY PARTY ADMITS THEIR SIN AND THE WEAKENING OF THE ELEMENTAL BALANCE. THEY WILL REPENT AND SUBMIT TO ANY PUNISHMENT THE CLERGY DEEMS APPROPRIATE, OR BE RELEASED IMMEDIATELY. LET THIS RECORD OF THEIR SIN WEIGH ON THE DIVINE'S JUDGEMENT AT THE GATES OF HEAVEN.<br/><br/>SIGNED,<br/><font color='red'>[signed]</font>"
