...
/datum/species/lupian
	name = "Lupian"
	id = "lupian"
	desc = "Lupians are a wolf-like people primarily hailing from the regions of Nortmidst. They are resilient, cunning and capable known for surviving the north thanks to their rugged pelts, sharp teeth and deep-rooted spirit of community."
