...
/datum/species/tabaxi
	...
	desc = "The Tabaxi are a race of Humanoid felines with a presence in history dating to the first Burning Emperor, Maruhadar I. Their bodies are slender and covered in spotted or striped fur. Like most felines, Tabaxi have long tails and retractable claws. Tabaxi fur color ranges from light yellow to brownish red. Tabaxi eyes are slit-pupilled and usually green or yellow. Tabaxi are competent swimmers and climbers as well as speedy runners. They have a good sense of balance and an acute sense of smell."
