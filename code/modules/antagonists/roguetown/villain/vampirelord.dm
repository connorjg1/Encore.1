...
/datum/objective/vampirelord/ascend
	name = "sun"
	explanation_text = "The One Star has spurned me long enough. I must conquer the Sun."
	team_explanation_text = ""
	triumph_count = 5
...
/datum/objective/vampirelord/infiltrate/two/check_completion()
	var/datum/game_mode/chaosmode/C = SSticker.mode
	var/list/noblejobs = list("Prince Regent", "Consort", "Prince", "Princess", "Hand", "Steward")
	for(var/datum/mind/V in C.vampires)
