...
/obj/structure/ascendant_altar/proc/ascend(mob/living/user)
	...
	switch(ascend_stage)
		if(1)
			...
			to_chat(user, span_danger("The first capstone. My mind opens. The world around me seems to get smaller. My pace stiffens."))
		...
		if(2)
			to_chat(user, span_danger("The second capstone. I see through the firmament. I see His form. THE ARCHDEVIL. ANGROS! IS HE DEAD, OR SLEEPING? ..."))
			sleep(30)
		...
		if(3)
			...
			sleep(20)
			to_chat(user, span_userdanger("The Earth weeps. I am not real. It hurts."))
			sleep(50)
...
//all goes dark. tp them over. give them their stats.
			...
			sleep(15 SECONDS)
			to_chat(user, span_mind_control("I must seat upon the throne of His lost Kingdom. I must rule as His eye, as He once did, as He will forevermore, as He now does."))
...
/obj/structure/ascendant_altar/proc/heavensaysdanger()
	priority_announce("THE MAD GOD AWAKENS", "The firmament crumbles, its cavities deepen. WHAT ONCE WAS, NOW IS.", 'sound/villain/ascendant_intro.ogg')
	sleep(15 SECONDS)
	to_chat(world, span_danger("The ground underneath THE THRONE shakes. The sky is opening. It seems the world has come to its miserable end."))
