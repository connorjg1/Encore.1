...
/datum/objective/aspirant/coup/one
	name = "Aspirant"
	explanation_text = "I must ensure that I am crowned as the Prince Regent."
	triumph_count = 5
...
/datum/objective/aspirant/coup/two
	name = "Moral"
	explanation_text = "I am no kinslayer, I must make sure that the Prince Regent doesn't die."
	triumph_count = 10
	var/initialruler
...
/datum/objective/aspirant/loyal/one
	name = "Ruler"
	explanation_text = "I must remain Prince Regent."
	triumph_count = 3
...
/datum/objective/aspirant/loyal/two
	name = "Loyalist"
	explanation_text = "I must ensure that the Prince Regent continues to reign."
	triumph_count = 3
	var/initialruler
