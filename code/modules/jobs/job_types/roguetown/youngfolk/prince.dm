...
/datum/advclass/heir/daring
	name = "Prideful Heir"
	tutorial = "You're a somebody, someone important. You were always able to harness the powers of the One Envy well, and have some semblance of control over a club, at least."
