/datum/job/roguetown/hand
	...
	tutorial = "You owe everything to your liege. Once, you were just a humble friend--now you are one of the most important people upon Domotan Island itself. You've killed more men with those lips than any blademaster could ever claim to."
	whitelist_req = TRUE
