/datum/job/roguetown/physician
	...
	tutorial = "An expert in all matters of the physical body, these doctors use scientific method first to mend the worst of wounds. When all else fails, seek alchemical solutions."
