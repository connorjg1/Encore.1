...
/datum/advclass/mercenary/blackoak
	...
	tutorial = "A shady guardian of the Black Oaks. Half mercenary band, half irregular militia fighting for control of their ancestral elven homeland of the Saint's Rest. Thankfully, you are not here today to shed the blood of Etgard's men- unless someone pays you to.."
