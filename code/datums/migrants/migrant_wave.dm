...
/datum/migrant_wave/pilgrim
	...
	greet_text = "Fleeing from misfortune and hardship, you and a handful of survivors sail closer to Domotan Island, looking for refuge and work, finally almost being there, almost..."
...
/datum/migrant_wave/adventurer
	...
	greet_text = "Together with a party of trusted friends we decided to venture out, seeking thrills, glory and treasure, ending up in the misty and damp bog underneath Etgard Keep, perhaps getting ourselves into more than what we bargained for."
