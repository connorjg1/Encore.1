...
/datum/skill/labor/fishing
	...
	dreams = list(
		...
		"...the old merchant nods his head, and gives you a small sack of baits: worms, grubs and even slices of cheese - each said to bring you another of Mjallidhorn's bounties..."
	)
