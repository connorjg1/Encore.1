...
/obj/structure/telescope/attack_hand(mob/user)
	...
	var/random_message = pick("You can see the Dark Wanderer rotating.", "Looking at the One Star blinds you!", "The stars smile at you.", "Betelgeuse is red today.", "Blessed yellow strife.", "You see a star!")
	to_chat(H, span_notice("[random_message]"))

	if(random_message == "Looking at the One Star blinds you!")
...
/obj/structure/globe/attack_hand(mob/user)
	...
	var/mob/living/carbon/human/H = user
	var/random_message = pick("you spin the globe!", "You land on Domotan Island!", "You land on the Far South!", "You land on the Old Kui!.", "You land on the Clash!", "You land on the Sea of Life!")
	to_chat(H, span_notice("[random_message]"))
