...
/datum/game_mode/chaosmode/proc/pick_bandits()
	...
	restricted_jobs = list("Prince Regent",
	"Consort",
	"Merchant",
	"Priest",
	"Royal Guard")
...
/datum/game_mode/chaosmode/proc/pick_maniac()
	restricted_jobs = list("Prince Regent", "Consort")
...
/datum/game_mode/chaosmode/proc/pick_lich()
	restricted_jobs = list("Prince Regent", "Consort", "Royal Guard", "Guard Captain")
