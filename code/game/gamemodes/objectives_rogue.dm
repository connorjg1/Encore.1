...
/datum/objective/werewolf
	name = "conquer"
	explanation_text = "You are touched by the crazed affliction of Angros' curse - be it through a bite... Or a terrible blessing. And you are SO, SO VERY HUNGRY. The form that the Mad God promises will be fearsome, but the transition will be agonizing. Fear not the darkness of Hell - and let the feast begin."
	team_explanation_text = "Lycanthropy is a terrible disease that's been recorded in scattered accounts going back hundreds of years. Whatever madness drove Angros to create such an aberration is beyond mortal minds - and whatever the reason, he has been unwilling or unable to undo it. Nightly transformations and prodigious increses in mass drive the body into an active state of insatiable starvation, driving animalistic, rabid behavior."
	triumph_count = 5
...
/datum/objective/vampire
	name = "conquer"
	explanation_text = "Put an end to the werewolf menace upon Domotan Island, or unite with them against the forces of the Aspects."
	team_explanation_text = "The feud between werewolves and vampires reaches back to the dawn of time. Will the two factions destroy each other, or find a way to coexist and face the mortals of Domotan Island together?"
	triumph_count = 5
