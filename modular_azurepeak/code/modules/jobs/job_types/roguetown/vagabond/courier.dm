/datum/advclass/vagabond_courier
	...
	tutorial = "Entrusted with a message of great import, your fortunes fell by the roadside at the behest of a group of heretic scum. Bereft of mount and master, you now wander the realm for purpose and sustenance."
